  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f3f5f9', fontFamily: 'Inter,system-ui,sans-serif' }}>
      <header style={{ height: 68, background: '#fff', borderBottom: '1px solid #e5e9f0', display: 'flex', alignItems: 'center', padding: '0 20px', gap: 14, position: 'sticky', top: 0, zIndex: 5 }}>
        ...
        <div style={{ marginLeft: 'auto', display: 'flex', gap: 10, alignItems: 'center' }}><input placeholder="Search..." value={q} onChange={(e) => setQ(e.target.value)} style={{ ...inp, width: 180 }} /><div style={{ width: 36, height: 36, borderRadius: '50%', background: NAVY, color: '#fff', display: 'grid', placeItems: 'center', fontWeight: 800 }}>T</div></div>
      </header>
