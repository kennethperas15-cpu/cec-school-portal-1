-- CEC School Portal — full database v3 (2026-09-25)
-- Source: live MySQL cec_portal (structure only, no user data)
-- Includes portal_items + migration 003 (failed_login_attempts, locked_until, school config)
-- Install: mysql -u <user> -p < cec_portal_v3_full.sql   (creates + seeds cec_portal)
